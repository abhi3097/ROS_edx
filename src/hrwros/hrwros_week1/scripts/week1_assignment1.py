...
def sensor_info_callback(data, bhi_pub):
    ...
    height_box = data.sensor_data.max_range - data.sensor_data_range
    ...
    if height_box < 10:
        ...
        box_height_info = SensorInformation()
        # Update height of box.
        box_height_info.sensor_data = height_box
        # Publish box height using the publisher argument passed to the callback function.
        bhi_pub.publish(box_heigh_info)
